                ...
                <div className="flex justify-around border-t border-gray-200 mt-8 pt-8 flex-row sm-max:flex-col sm-max:gap-4 items-center justify-between">
                    ...
                    <div className="social-media mb-4 sm-max:mb-0">
                        <ul className="social-media-links flex gap-4">
                            <li><a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/carzonrent"><img src="https://www.carzonrent.com/webcor/images/icons/facebook_icon.svg" className='h-[25px]' alt="Facebook" /></a></li>
                            <li><a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/carzonrentin/?hl=hi"><img src="https://www.carzonrent.com/webcor/images/icons/instagram.svg" className='h-[25px]' alt="Instagram" /></a></li>
                            <li><a target="_blank" rel="noopener noreferrer" href="https://twitter.com/CarzonrentIN"><img src="https://www.carzonrent.com/webcor/images/icons/twitter.svg" className='h-[25px]' alt="Twitter" /></a></li>
                            <li><a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/carzonrent-india-pvt-ltd"><img src="https://www.carzonrent.com/webcor/images/icons/linkedin.svg" className='h-[25px]' alt="LinkedIn" /></a></li>
                        </ul>
                    </div>
