        ...
        <BrowserRouter>
            ...
            <div className="about-us-wrapper h-fit w-screen box-border flex justify-center">
                <div className="about-us w-[80%] sm-max:w-[95%]">
                    ...
                    <button className='read-more-btn px-[25px] py-[10px] border border-yellow-400 rounded-full text-yellow-400 transition-all duration-[0.15s] ease-in-out sm-max:w-full hover:bg-yellow-400 hover:text-black'>Read More</button>
                </div>
            </div>
